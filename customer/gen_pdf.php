...
$con = mysqli_connect('localhost','root','12012');
mysqli_select_db($con,"my_dairy");
...
$sql="SELECT * FROM milk_production ";
$result = mysqli_query($con,$sql);
while ($rows=mysqli_fetch_array($result))
{
    $pdf->Cell(30, 10, $rows['ref_no'], 1);
	$pdf->Cell(60, 10, $rows['Tag_name'], 1);
	$pdf->Cell(25, 10, $rows['milk_date'], 1);
	$pdf->Cell(25, 10, $rows['lit_milk'], 1);
